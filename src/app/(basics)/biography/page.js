...
export const Graduated = ({ year }) => {
  return <div>{year && <h2>Graduated</h2>}</div>;
};
    ...
    if (name) {
      return (
        <>
          ...
          <p>
            Hi! My name is {name}, and I am a software developer with a passion
            for creating web applications. I enjoy working with modern
            frameworks like Next.js and exploring new technologies.
          </p>
        </>
      );
    } else {
...
export const Interests = () => {
  return (
    <p>
      In my free time, I like to read, learn about new programming trends, and
